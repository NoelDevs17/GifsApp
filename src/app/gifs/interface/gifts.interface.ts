// To parse this data:
//
//   import { Convert, SearchGIFClass } from "./file";
//
//   const searchGIFClass = Convert.toSearchGIFClass(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SearchGIFClass {
  data:       Gifs[];
...
export class Convert {
  public static toSearchGIFClass(json: string): SearchGIFClass {
      return cast(JSON.parse(json), r("SearchGIFClass"));
  }

  public static searchGIFClassToJson(value: SearchGIFClass): string {
      return JSON.stringify(uncast(value, r("SearchGIFClass")), null, 2);
  }
}
